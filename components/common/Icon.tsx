...
export const StarIcon: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 100 100" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M50,0 L61.2,35.3 L98.8,38.8 L71.2,64.7 L79.4,100 L50,80 L20.6,100 L28.8,64.7 L1.2,38.8 L38.8,35.3 Z" />
  </svg>
);
...
export const BriefcaseIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25v-4.07a2.25 2.25 0 01.97-1.73L12 4.56l7.28 7.86a2.25 2.25 0 01.97 1.73z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21l-1.37-1.37a2.25 2.25 0 01-.63-1.58V16.5a2.25 2.25 0 012.25-2.25h1.5a2.25 2.25 0 012.25 2.25v1.55a2.25 2.25 0 01-.63 1.58L12 21z" />
    </svg>
);
...
export const LightBulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-11.628a6.01 6.01 0 00-1.5-1.5A6.01 6.01 0 006.75 6.75a6.01 6.01 0 001.5 11.628m3-11.628V5.25" />
...
export const CogIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-1.227l.983-.393a2.25 2.25 0 012.12 0l.983.393c.55.22.99.685 1.11 1.227l.128.771c.27.994.99 1.714 1.984 1.984l.771.128c.542.09.997.56 1.227 1.11l.393.983a2.25 2.25 0 010 2.12l-.393.983c-.22.55-.685.99-1.227 1.11l-.771.128c-.994.27-1.714.99-1.984 1.984l-.128.771c-.09.542-.56 1.007-1.11 1.227l-.983.393a2.25 2.25 0 01-2.12 0l-.983-.393c-.55-.22-.99-.685-1.11-1.227l-.128-.771c-.27-.994-.99-1.714-1.984-1.984l-.771-.128c-.542-.09-1.007-.56-1.227-1.11l-.393-.983a2.25 2.25 0 010-2.12l.393-.983c.22-.55.685.99 1.227 1.11l.771-.128c.994-.27 1.714-.99 1.984-1.984l.128-.771z" />
...
export const PaperClipIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3.375 3.375 0 1118.5 6.582l-9.94 9.94a1.5 1.5 0 01-2.122-2.122l7.693-7.693-2.122-2.122-7.693 7.693a4.5 4.5 0 006.364 6.364l7.693-7.693a3.375 3.375 0 00-4.773-4.773l-10.94 10.94a1.5 1.5 0 102.122 2.122l9.94-9.94" />
    </svg>
);
